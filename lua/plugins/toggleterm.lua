return {
  ...
  config = function()
    ...
    local posting = Terminal:new({ cmd = "posting", hidden = true, count = 7 })
    local lazydocker = Terminal:new({ cmd = "lazydocker", hidden = true, count = 8 })
    ...
    vim.keymap.set("n", "<leader>lh", "<cmd>lua _posting_toggle()<CR>", { noremap = true, silent = true })
